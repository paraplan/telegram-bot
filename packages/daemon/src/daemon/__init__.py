def main():
    ...
    from daemon.db_bridge import update_schedules
    from daemon.schedule_fetcher import get_schedules_for_updating
    from env import DAEMON_CRONTAB, DAEMON_LOGGER_LEVEL, TIMEZONE
